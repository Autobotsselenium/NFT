...
public class Reports_Volvo
{
	...
	public static void main(String[] args) {
		System.out.println(Reports_Volvo.randomdigit(13));
	}
...
//    		}
	...
	public Reports_Volvo(LinkedHashMap<String, String> data, WebDriver driver, int count,Session ses) {
		super();
		this.driver = driver;
		this.data = data;
		this.session = ses;
	...
	public void Dashdownload() throws Exception 
	{
		...
		case "Dev":
			URL="https://dev-vssm.crm4.dynamics.com/";
			break;
		case "Test":
			URL="https://test-vssm.crm4.dynamics.com/";
			break;
		case "QA":
			URL="https://qa-vssm.crm4.dynamics.com/";
			break;
		case "Prod":
			URL="https://vssm.crm4.dynamics.com/";
			break;
		}}else {
			switch(session.getTestData("Level")) {
			case "Dev":
		...
		Thread.sleep(10000);
		session.clickElement(Dash);
		session.clickElement(VSSMrep);
		session.arrowup();
		...
		session.status(Status.PASS, "Sceenshot Attached");
